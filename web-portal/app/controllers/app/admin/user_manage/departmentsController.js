...
define(['app'], function (app) {
	...
	var departmentsController = function (growl, $rootScope, $scope, _, constantService, $filter, navigationService, authorizationService, localStorageService,
		configurationService, ngProgress, apiService, modalService, loadService) {


		var entryPage = 'department';
		...
		var doPagination = function (filteredResult) {
			...
			$scope.pageItemText = constantService.getPageItemText($scope.pageDataBegin, $scope.pageDataEnd,
				$scope.pageDataTotal, "Departments", 'English');
		};
    ...
    app.register.controller('departmentsController', ['growl', '$rootScope', '$scope', '_', 'constantService', '$filter', 'navigationService', 'authorizationService',
